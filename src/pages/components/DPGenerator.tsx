              ...
              <div className="text-center space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-gray-600">
                    Our DP Generator is under development. You'll soon be able
                    to create amazing profile pictures with custom backgrounds
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-2 text-xs text-gray-600">
                    <span className="bg-[#34A853]/10 px-2 py-1 rounded">
                      Custom Frames
                    </span>
                    <span className="bg-[#4285F4]/10 px-2 py-1 rounded">
                      Google Colors
                    </span>
                    <span className="bg-[#EA4335]/10 px-2 py-1 rounded">
                      Event Badges
                    </span>
                    <span className="bg-[#F9AB00]/10 px-2 py-1 rounded">
                      Easy Share
                    </span>
                  </div>
                </motion.div>
