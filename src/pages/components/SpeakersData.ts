const currentSpeakers = [
  // Pre-DevFest Series
  {
    ...
    session: {
      title: "Scaling Databases for the Future: Strategies That Power Millions",
...

  {
    ...
    bio: "Product Designer at Grey specializing in intelligent interfaces and user trust.",
    bioLong:
      "Timothy Ogundipe is a Product & Interaction Designer at Grey with over 5 years of experience designing intuitive digital experiences. His work focuses on trust, feedback loops, and human-AI interaction—making intelligent systems more predictable, more transparent, and more human-centered.",
    session: {
      title:
...

  {
    ...
    bio: "Senior Software Engineer specializing in microfrontends & scalable frontend systems.",
    bioLong:
      "Adeniji Oluwaferanmi is a Senior Software Engineer at Moniepoint with deep expertise in React, microfrontends, and scalable architecture patterns. His open-source library Connectic has been used in 15+ production projects across teams.",
    session: {
...

  {
    ...
    bio: "Brand identity designer crafting trustworthy, human-centered brands.",
    bioLong:
