    ...
    <section className="relative bg-white overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-12 md:py-16 relative z-10">
        ...
        >
          ...
          >
            Show your excitement for DevFest 2025 with a personalized display
            picture. Let everyone know you'll be there!
          </motion.p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          >
            <h3 className="text-2xl font-bold mb-6 md:mb-8">
              Create your DP in 4 simple steps:
            </h3>
            ...
            <div className="space-y-4 md:space-y-6 mb-8 md:mb-10">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-700">
                    Select a photo from your device to personalize your DP
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-700">
                    Choose from our Google-inspired color palette
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-700">
                    See how your personalized DP will look before finalizing
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-700">
                    Download your DP or share it directly on social media
                  </p>
                </div>
              </motion.div>
            </div>
